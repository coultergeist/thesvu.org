<?php exit; ?>{
    ...
    "minify.css.groups": {
        "null": {
            "default": {
                "include": {
                    "files": [
                        "\u2026ize_b1be5497a47c910a789fe6b5fc0464a0.css",
                        "https:\/\/fonts.googleapis.com\/\u2026talic&subset=latin%2Clatin-ext&ver=1.4.1"
                    ]
                }
            }
        }
    ...
    "minify.js.groups": {
        "null": {
            "default": {
                "include": {
                    "files": [
                        "http:\/\/www.thesvu.org\/\u2026-includes\/js\/jquery\/jquery.js?ver=1.12.4",
                        "http:\/\/maps.google.com\/\u2026anoramio%2Cdrawing&language=en&ver=4.8.1"
                    ]
                }
            }
        }
    ...
    "widget.pagespeed.key": "AIzaSyB5mnEcNjEYOEja7EWoQN1AGL6fdWGT0_s",
