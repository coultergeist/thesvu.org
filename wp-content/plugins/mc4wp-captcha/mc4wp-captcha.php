...
Plugin URI: https://mc4wp.com/#utm_source=wp-plugin&utm_medium=mc4wp-captcha&utm_campaign=plugins-page
Description: Adds a Google reCAPTCHA field to MailChimp for WordPress sign-up forms.
Version: 1.1
Author: ibericode
...
Copyright (C) 2015-2017, Danny van Kooten, danny@ibericode.com
 ...
 * @return bool
 */
function _bootstrap_mc4wp_captcha() {
...
add_action( 'plugins_loaded', '_bootstrap_mc4wp_captcha', 30 );
